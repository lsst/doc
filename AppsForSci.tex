...
To create a masked image using files of your own for the image and variance image, simply replace the dimensions in the example above with the usual string of the file name.  We will explain later how to specify which mask planes you want to use in your masked image.
